...
export class Migration20220403202926 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "category" drop constraint "category_parent_category_id_unique";');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "category" add constraint "category_parent_category_id_unique" unique ("parent_category_id");');
  }
